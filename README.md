...
Reimplement three popular deep learning methods:
 + 2.1 Neural Attentive Recommendation System (NARM). [Link paper](https://arxiv.org/pdf/1711.04725)
 + 2.2 Transformer-based Recommendation System (inspired by Behaviour Sequence Transformer Model - BST). [Link paper](https://arxiv.org/pdf/1905.06874)
 + 2.3 Bidirectional Encoder Representations from Transformers - BERT4Rec. [Link paper](https://arxiv.org/pdf/1904.06690)
